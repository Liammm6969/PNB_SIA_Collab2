...
const ManageStaff = () => {
  ...
  const getDepartmentBadge = (department) => {
    ...
    return <Badge bg={colors[department] || "secondary"}>{department}</Badge>;
  };
      ...
      <Container fluid className="px-4">
        ...
        <Row className="g-4 mb-4">
          {departments.map((dept) => {
            ...
            const percentage =
              staff.length > 0
                ? ((deptCount / staff.length) * 100).toFixed(1)
                : 0;
                            ...
                            <div className="d-flex gap-1 justify-content-center">
                              ...
                              >
                                <Button
                                  ...
                                  className="rounded-circle p-2 border-0 shadow-sm"
                                  onClick={() =>
                                    handleDeleteStaff(member.staffId)
                                  }
                                  style={{
                                    width: "36px",
                                    height: "36px",
              ...
              <>
                ...
                >
                  ...
                  <p className="mb-2 opacity-75">
                    {selectedStaff.staffStringId ||
                      `STAFF_${selectedStaff.staffId}`}
                  </p>
                  <Badge
                    ...
                    >
                      <div className="text-center py-5">
                        ...
                        <p className="text-muted">
                          Staff activity logs will be displayed here
                        </p>
                      </div>
                    </Tab>
                  </Tabs>
